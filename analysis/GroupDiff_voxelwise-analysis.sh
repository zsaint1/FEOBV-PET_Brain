...
####################################################################
sample="18patients-33controls"
contrast="contrast_g2v0"
GLM="18patients-33controls--FINALITY-nLin_precise_SUVR-in-MNI-2mm__contrast_g2v0"
SUVR_prefix="nLin_precise_SUVR-in-MNI-2mm"
FSGD="${gr_analyses_dir}/18patients-33controls--FINALITY-nLin_precise_SUVR-in-MNI-2mm__contrast_g2v0.fsgd"
CONTRAST="${gr_analyses_dir}/contrast_g2v0.mtx"
####################################################################
